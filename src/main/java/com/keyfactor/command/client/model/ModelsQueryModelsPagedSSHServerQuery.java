...
public class ModelsQueryModelsPagedSSHServerQuery {
  ...
  public ModelsQueryModelsPagedSSHServerQuery() {
  }

  public ModelsQueryModelsPagedSSHServerQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHServerQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHServerQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHServerQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHServerQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedSSHServerQuery modelsQueryModelsPagedSSHServerQuery = (ModelsQueryModelsPagedSSHServerQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedSSHServerQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedSSHServerQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedSSHServerQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedSSHServerQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedSSHServerQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedSSHServerQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedSSHServerQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedSSHServerQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedSSHServerQuery is not found in the empty JSON string", ModelsQueryModelsPagedSSHServerQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedSSHServerQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedSSHServerQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedSSHServerQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedSSHServerQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedSSHServerQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedSSHServerQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedSSHServerQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedSSHServerQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedSSHServerQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedSSHServerQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedSSHServerQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedSSHServerQuery
  */
  public static ModelsQueryModelsPagedSSHServerQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedSSHServerQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedSSHServerQuery to an JSON string
  *
  * @return JSON string
  */
