...
public class ModelsQueryModelsPagedSSHUserQuery {
  ...
  public ModelsQueryModelsPagedSSHUserQuery() {
  }

  public ModelsQueryModelsPagedSSHUserQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHUserQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHUserQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHUserQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHUserQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedSSHUserQuery modelsQueryModelsPagedSSHUserQuery = (ModelsQueryModelsPagedSSHUserQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedSSHUserQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedSSHUserQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedSSHUserQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedSSHUserQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedSSHUserQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedSSHUserQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedSSHUserQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedSSHUserQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedSSHUserQuery is not found in the empty JSON string", ModelsQueryModelsPagedSSHUserQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedSSHUserQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedSSHUserQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedSSHUserQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedSSHUserQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedSSHUserQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedSSHUserQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedSSHUserQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedSSHUserQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedSSHUserQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedSSHUserQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedSSHUserQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedSSHUserQuery
  */
  public static ModelsQueryModelsPagedSSHUserQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedSSHUserQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedSSHUserQuery to an JSON string
  *
  * @return JSON string
  */
