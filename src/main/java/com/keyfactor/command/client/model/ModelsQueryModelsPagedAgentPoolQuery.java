...
public class ModelsQueryModelsPagedAgentPoolQuery {
  ...
  public ModelsQueryModelsPagedAgentPoolQuery() {
  }

  public ModelsQueryModelsPagedAgentPoolQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentPoolQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentPoolQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentPoolQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentPoolQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedAgentPoolQuery modelsQueryModelsPagedAgentPoolQuery = (ModelsQueryModelsPagedAgentPoolQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedAgentPoolQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedAgentPoolQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedAgentPoolQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedAgentPoolQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedAgentPoolQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedAgentPoolQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedAgentPoolQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedAgentPoolQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedAgentPoolQuery is not found in the empty JSON string", ModelsQueryModelsPagedAgentPoolQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedAgentPoolQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedAgentPoolQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedAgentPoolQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedAgentPoolQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedAgentPoolQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedAgentPoolQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedAgentPoolQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedAgentPoolQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedAgentPoolQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedAgentPoolQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedAgentPoolQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedAgentPoolQuery
  */
  public static ModelsQueryModelsPagedAgentPoolQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedAgentPoolQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedAgentPoolQuery to an JSON string
  *
  * @return JSON string
  */
