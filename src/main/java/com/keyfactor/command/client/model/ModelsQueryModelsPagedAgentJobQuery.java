...
public class ModelsQueryModelsPagedAgentJobQuery {
  ...
  public ModelsQueryModelsPagedAgentJobQuery() {
  }

  public ModelsQueryModelsPagedAgentJobQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentJobQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentJobQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentJobQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentJobQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedAgentJobQuery modelsQueryModelsPagedAgentJobQuery = (ModelsQueryModelsPagedAgentJobQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedAgentJobQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedAgentJobQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedAgentJobQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedAgentJobQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedAgentJobQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedAgentJobQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedAgentJobQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedAgentJobQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedAgentJobQuery is not found in the empty JSON string", ModelsQueryModelsPagedAgentJobQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedAgentJobQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedAgentJobQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedAgentJobQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedAgentJobQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedAgentJobQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedAgentJobQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedAgentJobQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedAgentJobQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedAgentJobQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedAgentJobQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedAgentJobQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedAgentJobQuery
  */
  public static ModelsQueryModelsPagedAgentJobQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedAgentJobQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedAgentJobQuery to an JSON string
  *
  * @return JSON string
  */
