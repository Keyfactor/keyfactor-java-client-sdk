...
public class ModelsQueryModelsPagedSSHLogonQuery {
  ...
  public ModelsQueryModelsPagedSSHLogonQuery() {
  }

  public ModelsQueryModelsPagedSSHLogonQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHLogonQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHLogonQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHLogonQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedSSHLogonQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedSSHLogonQuery modelsQueryModelsPagedSSHLogonQuery = (ModelsQueryModelsPagedSSHLogonQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedSSHLogonQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedSSHLogonQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedSSHLogonQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedSSHLogonQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedSSHLogonQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedSSHLogonQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedSSHLogonQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedSSHLogonQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedSSHLogonQuery is not found in the empty JSON string", ModelsQueryModelsPagedSSHLogonQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedSSHLogonQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedSSHLogonQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedSSHLogonQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedSSHLogonQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedSSHLogonQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedSSHLogonQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedSSHLogonQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedSSHLogonQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedSSHLogonQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedSSHLogonQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedSSHLogonQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedSSHLogonQuery
  */
  public static ModelsQueryModelsPagedSSHLogonQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedSSHLogonQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedSSHLogonQuery to an JSON string
  *
  * @return JSON string
  */
