...
public class KeyfactorApiModelsSslNetworkQueryResponse {
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse() {
  }

  public KeyfactorApiModelsSslNetworkQueryResponse networkId(UUID networkId) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse name(String name) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse agentPoolName(String agentPoolName) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse agentPoolId(UUID agentPoolId) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse description(String description) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse discoverSchedule(KeyfactorCommonSchedulingKeyfactorSchedule discoverSchedule) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse monitorSchedule(KeyfactorCommonSchedulingKeyfactorSchedule monitorSchedule) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse discoverPercentComplete(Double discoverPercentComplete) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse monitorPercentComplete(Double monitorPercentComplete) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse discoverStatus(DiscoverStatusEnum discoverStatus) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse monitorStatus(MonitorStatusEnum monitorStatus) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse discoverLastScanned(OffsetDateTime discoverLastScanned) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse monitorLastScanned(OffsetDateTime monitorLastScanned) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse sslAlertRecipients(List<String> sslAlertRecipients) {
    
    this.sslAlertRecipients = sslAlertRecipients;
    return this;
  }

  public KeyfactorApiModelsSslNetworkQueryResponse addSslAlertRecipientsItem(String sslAlertRecipientsItem) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse autoMonitor(Boolean autoMonitor) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse getRobots(Boolean getRobots) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse discoverTimeoutMs(Double discoverTimeoutMs) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse monitorTimeoutMs(Double monitorTimeoutMs) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse expirationAlertDays(Double expirationAlertDays) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse discoverJobParts(Integer discoverJobParts) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse monitorJobParts(Integer monitorJobParts) {
  ...
  **/
  ...
  public KeyfactorApiModelsSslNetworkQueryResponse quietHours(List<KeyfactorApiModelsSslQuietHourResponse> quietHours) {
    
    this.quietHours = quietHours;
    return this;
  }

  public KeyfactorApiModelsSslNetworkQueryResponse addQuietHoursItem(KeyfactorApiModelsSslQuietHourResponse quietHoursItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    KeyfactorApiModelsSslNetworkQueryResponse keyfactorApiModelsSslNetworkQueryResponse = (KeyfactorApiModelsSslNetworkQueryResponse) o;
    return Objects.equals(this.networkId, keyfactorApiModelsSslNetworkQueryResponse.networkId) &&
        Objects.equals(this.name, keyfactorApiModelsSslNetworkQueryResponse.name) &&
        Objects.equals(this.agentPoolName, keyfactorApiModelsSslNetworkQueryResponse.agentPoolName) &&
        Objects.equals(this.agentPoolId, keyfactorApiModelsSslNetworkQueryResponse.agentPoolId) &&
        Objects.equals(this.description, keyfactorApiModelsSslNetworkQueryResponse.description) &&
        Objects.equals(this.enabled, keyfactorApiModelsSslNetworkQueryResponse.enabled) &&
        Objects.equals(this.discoverSchedule, keyfactorApiModelsSslNetworkQueryResponse.discoverSchedule) &&
        Objects.equals(this.monitorSchedule, keyfactorApiModelsSslNetworkQueryResponse.monitorSchedule) &&
        Objects.equals(this.discoverPercentComplete, keyfactorApiModelsSslNetworkQueryResponse.discoverPercentComplete) &&
        Objects.equals(this.monitorPercentComplete, keyfactorApiModelsSslNetworkQueryResponse.monitorPercentComplete) &&
        Objects.equals(this.discoverStatus, keyfactorApiModelsSslNetworkQueryResponse.discoverStatus) &&
        Objects.equals(this.monitorStatus, keyfactorApiModelsSslNetworkQueryResponse.monitorStatus) &&
        Objects.equals(this.discoverLastScanned, keyfactorApiModelsSslNetworkQueryResponse.discoverLastScanned) &&
        Objects.equals(this.monitorLastScanned, keyfactorApiModelsSslNetworkQueryResponse.monitorLastScanned) &&
        Objects.equals(this.sslAlertRecipients, keyfactorApiModelsSslNetworkQueryResponse.sslAlertRecipients) &&
        Objects.equals(this.autoMonitor, keyfactorApiModelsSslNetworkQueryResponse.autoMonitor) &&
        Objects.equals(this.getRobots, keyfactorApiModelsSslNetworkQueryResponse.getRobots) &&
        Objects.equals(this.discoverTimeoutMs, keyfactorApiModelsSslNetworkQueryResponse.discoverTimeoutMs) &&
        Objects.equals(this.monitorTimeoutMs, keyfactorApiModelsSslNetworkQueryResponse.monitorTimeoutMs) &&
        Objects.equals(this.expirationAlertDays, keyfactorApiModelsSslNetworkQueryResponse.expirationAlertDays) &&
        Objects.equals(this.discoverJobParts, keyfactorApiModelsSslNetworkQueryResponse.discoverJobParts) &&
        Objects.equals(this.monitorJobParts, keyfactorApiModelsSslNetworkQueryResponse.monitorJobParts) &&
        Objects.equals(this.quietHours, keyfactorApiModelsSslNetworkQueryResponse.quietHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyfactorApiModelsSslNetworkQueryResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to KeyfactorApiModelsSslNetworkQueryResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KeyfactorApiModelsSslNetworkQueryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeyfactorApiModelsSslNetworkQueryResponse is not found in the empty JSON string", KeyfactorApiModelsSslNetworkQueryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!KeyfactorApiModelsSslNetworkQueryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeyfactorApiModelsSslNetworkQueryResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeyfactorApiModelsSslNetworkQueryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeyfactorApiModelsSslNetworkQueryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeyfactorApiModelsSslNetworkQueryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeyfactorApiModelsSslNetworkQueryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<KeyfactorApiModelsSslNetworkQueryResponse>() {
           @Override
           public void write(JsonWriter out, KeyfactorApiModelsSslNetworkQueryResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeyfactorApiModelsSslNetworkQueryResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of KeyfactorApiModelsSslNetworkQueryResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KeyfactorApiModelsSslNetworkQueryResponse
  * @throws IOException if the JSON string is invalid with respect to KeyfactorApiModelsSslNetworkQueryResponse
  */
  public static KeyfactorApiModelsSslNetworkQueryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeyfactorApiModelsSslNetworkQueryResponse.class);
  }

 /**
  * Convert an instance of KeyfactorApiModelsSslNetworkQueryResponse to an JSON string
  *
  * @return JSON string
  */
