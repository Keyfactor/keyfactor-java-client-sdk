...
public class ModelsQueryModelsPagedTemplateQuery {
  ...
  public ModelsQueryModelsPagedTemplateQuery() {
  }

  public ModelsQueryModelsPagedTemplateQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedTemplateQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedTemplateQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedTemplateQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedTemplateQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedTemplateQuery modelsQueryModelsPagedTemplateQuery = (ModelsQueryModelsPagedTemplateQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedTemplateQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedTemplateQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedTemplateQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedTemplateQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedTemplateQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedTemplateQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedTemplateQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedTemplateQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedTemplateQuery is not found in the empty JSON string", ModelsQueryModelsPagedTemplateQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedTemplateQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedTemplateQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedTemplateQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedTemplateQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedTemplateQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedTemplateQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedTemplateQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedTemplateQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedTemplateQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedTemplateQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedTemplateQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedTemplateQuery
  */
  public static ModelsQueryModelsPagedTemplateQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedTemplateQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedTemplateQuery to an JSON string
  *
  * @return JSON string
  */
