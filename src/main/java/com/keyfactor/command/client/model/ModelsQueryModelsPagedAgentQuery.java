...
public class ModelsQueryModelsPagedAgentQuery {
  ...
  public ModelsQueryModelsPagedAgentQuery() {
  }

  public ModelsQueryModelsPagedAgentQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAgentQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedAgentQuery modelsQueryModelsPagedAgentQuery = (ModelsQueryModelsPagedAgentQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedAgentQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedAgentQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedAgentQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedAgentQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedAgentQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedAgentQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedAgentQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedAgentQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedAgentQuery is not found in the empty JSON string", ModelsQueryModelsPagedAgentQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedAgentQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedAgentQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedAgentQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedAgentQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedAgentQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedAgentQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedAgentQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedAgentQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedAgentQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedAgentQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedAgentQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedAgentQuery
  */
  public static ModelsQueryModelsPagedAgentQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedAgentQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedAgentQuery to an JSON string
  *
  * @return JSON string
  */
