...
public class ModelsQueryModelsPagedScanJobPartsQuery {
  /**
  ...
  public ModelsQueryModelsPagedScanJobPartsQuery() {
  }

  public ModelsQueryModelsPagedScanJobPartsQuery jobType(JobTypeEnum jobType) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedScanJobPartsQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedScanJobPartsQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedScanJobPartsQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedScanJobPartsQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedScanJobPartsQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedScanJobPartsQuery modelsQueryModelsPagedScanJobPartsQuery = (ModelsQueryModelsPagedScanJobPartsQuery) o;
    return Objects.equals(this.jobType, modelsQueryModelsPagedScanJobPartsQuery.jobType) &&
        Objects.equals(this.queryString, modelsQueryModelsPagedScanJobPartsQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedScanJobPartsQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedScanJobPartsQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedScanJobPartsQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedScanJobPartsQuery.sortAscending);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobType, queryString, pageReturned, returnLimit, sortField, sortAscending);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelsQueryModelsPagedScanJobPartsQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedScanJobPartsQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedScanJobPartsQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedScanJobPartsQuery is not found in the empty JSON string", ModelsQueryModelsPagedScanJobPartsQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedScanJobPartsQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedScanJobPartsQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedScanJobPartsQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedScanJobPartsQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedScanJobPartsQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedScanJobPartsQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedScanJobPartsQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedScanJobPartsQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedScanJobPartsQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedScanJobPartsQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedScanJobPartsQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedScanJobPartsQuery
  */
  public static ModelsQueryModelsPagedScanJobPartsQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedScanJobPartsQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedScanJobPartsQuery to an JSON string
  *
  * @return JSON string
  */
