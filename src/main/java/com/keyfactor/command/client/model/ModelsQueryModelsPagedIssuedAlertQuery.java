...
public class ModelsQueryModelsPagedIssuedAlertQuery {
  ...
  public ModelsQueryModelsPagedIssuedAlertQuery() {
  }

  public ModelsQueryModelsPagedIssuedAlertQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedIssuedAlertQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedIssuedAlertQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedIssuedAlertQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedIssuedAlertQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedIssuedAlertQuery modelsQueryModelsPagedIssuedAlertQuery = (ModelsQueryModelsPagedIssuedAlertQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedIssuedAlertQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedIssuedAlertQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedIssuedAlertQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedIssuedAlertQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedIssuedAlertQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedIssuedAlertQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedIssuedAlertQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedIssuedAlertQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedIssuedAlertQuery is not found in the empty JSON string", ModelsQueryModelsPagedIssuedAlertQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedIssuedAlertQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedIssuedAlertQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedIssuedAlertQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedIssuedAlertQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedIssuedAlertQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedIssuedAlertQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedIssuedAlertQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedIssuedAlertQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedIssuedAlertQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedIssuedAlertQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedIssuedAlertQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedIssuedAlertQuery
  */
  public static ModelsQueryModelsPagedIssuedAlertQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedIssuedAlertQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedIssuedAlertQuery to an JSON string
  *
  * @return JSON string
  */
