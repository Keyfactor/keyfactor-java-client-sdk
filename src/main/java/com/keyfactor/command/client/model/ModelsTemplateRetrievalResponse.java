...
import com.keyfactor.command.client.model.ModelsTemplateRetrievalResponseExtendedKeyUsageModel;
import com.keyfactor.command.client.model.ModelsTemplateRetrievalResponseTemplateDefaultModel;
import com.keyfactor.command.client.model.ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel;
import com.keyfactor.command.client.model.ModelsTemplateRetrievalResponseTemplateMetadataFieldModel;
import com.keyfactor.command.client.model.ModelsTemplateRetrievalResponseTemplatePolicyModel;
import com.keyfactor.command.client.model.ModelsTemplateRetrievalResponseTemplateRegexModel;
...
public class ModelsTemplateRetrievalResponse {
  ...
  private List<ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel> enrollmentFields = null;

  public static final String SERIALIZED_NAME_METADATA_FIELDS = "MetadataFields";
  @SerializedName(SERIALIZED_NAME_METADATA_FIELDS)
  private List<ModelsTemplateRetrievalResponseTemplateMetadataFieldModel> metadataFields = null;
  ...
  private List<ModelsTemplateRetrievalResponseTemplateRegexModel> templateRegexes = null;
  ...
  private List<ModelsTemplateRetrievalResponseTemplateDefaultModel> templateDefaults = null;

  public static final String SERIALIZED_NAME_TEMPLATE_POLICY = "TemplatePolicy";
  @SerializedName(SERIALIZED_NAME_TEMPLATE_POLICY)
  private ModelsTemplateRetrievalResponseTemplatePolicyModel templatePolicy;
  ...
  private List<ModelsTemplateRetrievalResponseExtendedKeyUsageModel> extendedKeyUsages = null;

  public static final String SERIALIZED_NAME_CURVE = "Curve";
  @SerializedName(SERIALIZED_NAME_CURVE)
  private String curve;

  public ModelsTemplateRetrievalResponse() {
  }
  ...
  public ModelsTemplateRetrievalResponse id(Integer id) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse commonName(String commonName) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse templateName(String templateName) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse oid(String oid) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse keySize(String keySize) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse keyType(String keyType) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse configurationTenant(String configurationTenant) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse friendlyName(String friendlyName) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse keyRetention(KeyRetentionEnum keyRetention) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse keyRetentionDays(Integer keyRetentionDays) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse keyArchival(Boolean keyArchival) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse enrollmentFields(List<ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel> enrollmentFields) {
    
    this.enrollmentFields = enrollmentFields;
    return this;
  }

  public ModelsTemplateRetrievalResponse addEnrollmentFieldsItem(ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel enrollmentFieldsItem) {
  ...
  **/
  ...
  public List<ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel> getEnrollmentFields() {
    return enrollmentFields;
  }


  public void setEnrollmentFields(List<ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel> enrollmentFields) {
    this.enrollmentFields = enrollmentFields;
  }


  public ModelsTemplateRetrievalResponse metadataFields(List<ModelsTemplateRetrievalResponseTemplateMetadataFieldModel> metadataFields) {
    
    this.metadataFields = metadataFields;
    return this;
  }

  public ModelsTemplateRetrievalResponse addMetadataFieldsItem(ModelsTemplateRetrievalResponseTemplateMetadataFieldModel metadataFieldsItem) {
  ...
  **/
  ...
  public List<ModelsTemplateRetrievalResponseTemplateMetadataFieldModel> getMetadataFields() {
    return metadataFields;
  }


  public void setMetadataFields(List<ModelsTemplateRetrievalResponseTemplateMetadataFieldModel> metadataFields) {
    this.metadataFields = metadataFields;
  }


  public ModelsTemplateRetrievalResponse allowedEnrollmentTypes(AllowedEnrollmentTypesEnum allowedEnrollmentTypes) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse templateRegexes(List<ModelsTemplateRetrievalResponseTemplateRegexModel> templateRegexes) {
    
    this.templateRegexes = templateRegexes;
    return this;
  }

  public ModelsTemplateRetrievalResponse addTemplateRegexesItem(ModelsTemplateRetrievalResponseTemplateRegexModel templateRegexesItem) {
  ...
  **/
  ...
  public List<ModelsTemplateRetrievalResponseTemplateRegexModel> getTemplateRegexes() {
    return templateRegexes;
  }


  public void setTemplateRegexes(List<ModelsTemplateRetrievalResponseTemplateRegexModel> templateRegexes) {
    this.templateRegexes = templateRegexes;
  }


  public ModelsTemplateRetrievalResponse templateDefaults(List<ModelsTemplateRetrievalResponseTemplateDefaultModel> templateDefaults) {
    
    this.templateDefaults = templateDefaults;
    return this;
  }

  public ModelsTemplateRetrievalResponse addTemplateDefaultsItem(ModelsTemplateRetrievalResponseTemplateDefaultModel templateDefaultsItem) {
  ...
  **/
  ...
  public List<ModelsTemplateRetrievalResponseTemplateDefaultModel> getTemplateDefaults() {
    return templateDefaults;
  }


  public void setTemplateDefaults(List<ModelsTemplateRetrievalResponseTemplateDefaultModel> templateDefaults) {
    this.templateDefaults = templateDefaults;
  }


  public ModelsTemplateRetrievalResponse templatePolicy(ModelsTemplateRetrievalResponseTemplatePolicyModel templatePolicy) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponseTemplatePolicyModel getTemplatePolicy() {
    return templatePolicy;
  }


  public void setTemplatePolicy(ModelsTemplateRetrievalResponseTemplatePolicyModel templatePolicy) {
    this.templatePolicy = templatePolicy;
  }


  public ModelsTemplateRetrievalResponse useAllowedRequesters(Boolean useAllowedRequesters) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse allowedRequesters(List<String> allowedRequesters) {
    
    this.allowedRequesters = allowedRequesters;
    return this;
  }

  public ModelsTemplateRetrievalResponse addAllowedRequestersItem(String allowedRequestersItem) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse displayName(String displayName) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse rfCEnforcement(Boolean rfCEnforcement) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse requiresApproval(Boolean requiresApproval) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse keyUsage(Integer keyUsage) {
  ...
  **/
  ...
  public ModelsTemplateRetrievalResponse extendedKeyUsages(List<ModelsTemplateRetrievalResponseExtendedKeyUsageModel> extendedKeyUsages) {
    
    this.extendedKeyUsages = extendedKeyUsages;
    return this;
  }

  public ModelsTemplateRetrievalResponse addExtendedKeyUsagesItem(ModelsTemplateRetrievalResponseExtendedKeyUsageModel extendedKeyUsagesItem) {
  ...
  **/
  ...
  public List<ModelsTemplateRetrievalResponseExtendedKeyUsageModel> getExtendedKeyUsages() {
    return extendedKeyUsages;
  }


  public void setExtendedKeyUsages(List<ModelsTemplateRetrievalResponseExtendedKeyUsageModel> extendedKeyUsages) {
    this.extendedKeyUsages = extendedKeyUsages;
  }


  public ModelsTemplateRetrievalResponse curve(String curve) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsTemplateRetrievalResponse modelsTemplateRetrievalResponse = (ModelsTemplateRetrievalResponse) o;
    return Objects.equals(this.id, modelsTemplateRetrievalResponse.id) &&
        Objects.equals(this.commonName, modelsTemplateRetrievalResponse.commonName) &&
        Objects.equals(this.templateName, modelsTemplateRetrievalResponse.templateName) &&
        Objects.equals(this.oid, modelsTemplateRetrievalResponse.oid) &&
        Objects.equals(this.keySize, modelsTemplateRetrievalResponse.keySize) &&
        Objects.equals(this.keyType, modelsTemplateRetrievalResponse.keyType) &&
        Objects.equals(this.forestRoot, modelsTemplateRetrievalResponse.forestRoot) &&
        Objects.equals(this.configurationTenant, modelsTemplateRetrievalResponse.configurationTenant) &&
        Objects.equals(this.friendlyName, modelsTemplateRetrievalResponse.friendlyName) &&
        Objects.equals(this.keyRetention, modelsTemplateRetrievalResponse.keyRetention) &&
        Objects.equals(this.keyRetentionDays, modelsTemplateRetrievalResponse.keyRetentionDays) &&
        Objects.equals(this.keyArchival, modelsTemplateRetrievalResponse.keyArchival) &&
        Objects.equals(this.enrollmentFields, modelsTemplateRetrievalResponse.enrollmentFields) &&
        Objects.equals(this.metadataFields, modelsTemplateRetrievalResponse.metadataFields) &&
        Objects.equals(this.allowedEnrollmentTypes, modelsTemplateRetrievalResponse.allowedEnrollmentTypes) &&
        Objects.equals(this.templateRegexes, modelsTemplateRetrievalResponse.templateRegexes) &&
        Objects.equals(this.templateDefaults, modelsTemplateRetrievalResponse.templateDefaults) &&
        Objects.equals(this.templatePolicy, modelsTemplateRetrievalResponse.templatePolicy) &&
        Objects.equals(this.useAllowedRequesters, modelsTemplateRetrievalResponse.useAllowedRequesters) &&
        Objects.equals(this.allowedRequesters, modelsTemplateRetrievalResponse.allowedRequesters) &&
        Objects.equals(this.displayName, modelsTemplateRetrievalResponse.displayName) &&
        Objects.equals(this.rfCEnforcement, modelsTemplateRetrievalResponse.rfCEnforcement) &&
        Objects.equals(this.requiresApproval, modelsTemplateRetrievalResponse.requiresApproval) &&
        Objects.equals(this.keyUsage, modelsTemplateRetrievalResponse.keyUsage) &&
        Objects.equals(this.extendedKeyUsages, modelsTemplateRetrievalResponse.extendedKeyUsages) &&
        Objects.equals(this.curve, modelsTemplateRetrievalResponse.curve);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, commonName, templateName, oid, keySize, keyType, forestRoot, configurationTenant, friendlyName, keyRetention, keyRetentionDays, keyArchival, enrollmentFields, metadataFields, allowedEnrollmentTypes, templateRegexes, templateDefaults, templatePolicy, useAllowedRequesters, allowedRequesters, displayName, rfCEnforcement, requiresApproval, keyUsage, extendedKeyUsages, curve);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsTemplateRetrievalResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsTemplateRetrievalResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsTemplateRetrievalResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsTemplateRetrievalResponse is not found in the empty JSON string", ModelsTemplateRetrievalResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsTemplateRetrievalResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsTemplateRetrievalResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("EnrollmentFields") != null && !jsonObj.get("EnrollmentFields").isJsonNull()) {
        ...
        if (jsonArrayenrollmentFields != null) {
          ...
          for (int i = 0; i < jsonArrayenrollmentFields.size(); i++) {
            ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel.validateJsonObject(jsonArrayenrollmentFields.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("MetadataFields") != null && !jsonObj.get("MetadataFields").isJsonNull()) {
        ...
        if (jsonArraymetadataFields != null) {
          ...
          for (int i = 0; i < jsonArraymetadataFields.size(); i++) {
            ModelsTemplateRetrievalResponseTemplateMetadataFieldModel.validateJsonObject(jsonArraymetadataFields.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("TemplateRegexes") != null && !jsonObj.get("TemplateRegexes").isJsonNull()) {
        ...
        if (jsonArraytemplateRegexes != null) {
          ...
          for (int i = 0; i < jsonArraytemplateRegexes.size(); i++) {
            ModelsTemplateRetrievalResponseTemplateRegexModel.validateJsonObject(jsonArraytemplateRegexes.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("TemplateDefaults") != null && !jsonObj.get("TemplateDefaults").isJsonNull()) {
        ...
        if (jsonArraytemplateDefaults != null) {
          ...
          for (int i = 0; i < jsonArraytemplateDefaults.size(); i++) {
            ModelsTemplateRetrievalResponseTemplateDefaultModel.validateJsonObject(jsonArraytemplateDefaults.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `TemplatePolicy`
      if (jsonObj.get("TemplatePolicy") != null && !jsonObj.get("TemplatePolicy").isJsonNull()) {
        ModelsTemplateRetrievalResponseTemplatePolicyModel.validateJsonObject(jsonObj.getAsJsonObject("TemplatePolicy"));
      }
      ...
      if (jsonObj.get("ExtendedKeyUsages") != null && !jsonObj.get("ExtendedKeyUsages").isJsonNull()) {
        ...
        if (jsonArrayextendedKeyUsages != null) {
          ...
          for (int i = 0; i < jsonArrayextendedKeyUsages.size(); i++) {
            ModelsTemplateRetrievalResponseExtendedKeyUsageModel.validateJsonObject(jsonArrayextendedKeyUsages.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsTemplateRetrievalResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsTemplateRetrievalResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsTemplateRetrievalResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsTemplateRetrievalResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsTemplateRetrievalResponse>() {
           @Override
           public void write(JsonWriter out, ModelsTemplateRetrievalResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsTemplateRetrievalResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsTemplateRetrievalResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsTemplateRetrievalResponse
  * @throws IOException if the JSON string is invalid with respect to ModelsTemplateRetrievalResponse
  */
  public static ModelsTemplateRetrievalResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsTemplateRetrievalResponse.class);
  }

 /**
  * Convert an instance of ModelsTemplateRetrievalResponse to an JSON string
  *
  * @return JSON string
  */
