...
public class ModelsQueryModelsPagedAuditLogQuery {
  ...
  public ModelsQueryModelsPagedAuditLogQuery() {
  }

  public ModelsQueryModelsPagedAuditLogQuery queryString(String queryString) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAuditLogQuery pageReturned(Integer pageReturned) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAuditLogQuery returnLimit(Integer returnLimit) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAuditLogQuery sortField(String sortField) {
  ...
  **/
  ...
  public ModelsQueryModelsPagedAuditLogQuery sortAscending(SortAscendingEnum sortAscending) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsQueryModelsPagedAuditLogQuery modelsQueryModelsPagedAuditLogQuery = (ModelsQueryModelsPagedAuditLogQuery) o;
    return Objects.equals(this.queryString, modelsQueryModelsPagedAuditLogQuery.queryString) &&
        Objects.equals(this.pageReturned, modelsQueryModelsPagedAuditLogQuery.pageReturned) &&
        Objects.equals(this.returnLimit, modelsQueryModelsPagedAuditLogQuery.returnLimit) &&
        Objects.equals(this.sortField, modelsQueryModelsPagedAuditLogQuery.sortField) &&
        Objects.equals(this.sortAscending, modelsQueryModelsPagedAuditLogQuery.sortAscending);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsQueryModelsPagedAuditLogQuery {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelsQueryModelsPagedAuditLogQuery
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelsQueryModelsPagedAuditLogQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsQueryModelsPagedAuditLogQuery is not found in the empty JSON string", ModelsQueryModelsPagedAuditLogQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelsQueryModelsPagedAuditLogQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsQueryModelsPagedAuditLogQuery` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsQueryModelsPagedAuditLogQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsQueryModelsPagedAuditLogQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsQueryModelsPagedAuditLogQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsQueryModelsPagedAuditLogQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsQueryModelsPagedAuditLogQuery>() {
           @Override
           public void write(JsonWriter out, ModelsQueryModelsPagedAuditLogQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsQueryModelsPagedAuditLogQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsQueryModelsPagedAuditLogQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsQueryModelsPagedAuditLogQuery
  * @throws IOException if the JSON string is invalid with respect to ModelsQueryModelsPagedAuditLogQuery
  */
  public static ModelsQueryModelsPagedAuditLogQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsQueryModelsPagedAuditLogQuery.class);
  }

 /**
  * Convert an instance of ModelsQueryModelsPagedAuditLogQuery to an JSON string
  *
  * @return JSON string
  */
